    ...
    async def call_func(self,func_name, args):
        match func_name:
            ...
            case 'exit':
                os._exit(0)
            case 'help':
                return FormattedText([("class:title", f"GO to https://github.com//vortexosofficial/vortexosAI/issues ^_^")])
...
\t//   |/ /         / /    / /\  ((___/ /     ((___ / /    //     | | __/ /___
    ...
    print("\033[1;32m \t\tWelcome to VortexOSAI - Your Personal AI OS\033[0m\n")

    introduce = """
\tVortexOSAI (Open and Do Anything Now with AI) is revolutionizing the 
...
\tinteroperability. VortexOSAI empowers users to craft powerful AI agents:
...
"""
    ...
    print("\033[1;33m \tVortexOSAI is an open-source project, let's define the future of Humans and AI together.\033[0m")
    print("\033[1;33m \tGithub\t: https://github.com//vortexosofficial/vortexosAI\033[0m")
    print("\033[1;33m \tWebsite\t: https://www.vortexos.org\033[0m")
    print("\n\n")
